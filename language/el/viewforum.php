...
$lang = array_merge($lang, array(
	...
	'LOGIN_NOTIFY_FORUM'	=> 'Έχετε ειδοποιηθεί για αυτή τη Δ. Συζήτηση, παρακαλώ συνδεθείτε για να την προβάλετε.',
	...
	'NO_READ_ACCESS'			=> 'Δεν έχετε τα απαραίτητα δικαιώματα για να προβάλετε ή να διαβάσετε θέματα αυτής της Δ. Συζήτησης.',
	'NO_FORUMS_IN_CATEGORY'	=> 'Αυτή η κατηγορία, δεν έχει Δ. Συζητήσεις.',
