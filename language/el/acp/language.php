...
$lang = array_merge($lang, array(
	...
	'LANGUAGE_PACK_DELETED'				=> 'Το αρχείο γλώσσας “%s” έχει αφαιρεθεί με επιτυχία. Όλα τα μέλη που χρησιμοποιούσαν αυτή τη γλώσσα ρυθμίσθηκαν στην προεπιλεγμένη γλώσσα του συστήματος συζητήσεων.',
	...
	'NO_REMOVE_DEFAULT_LANG'		=> 'Δεν μπορείτε να απo-εγκαταστήσετε το προεπιλεγμένο πακέτο γλώσσας.<br />Αν θέλετε να το απo-εγκαταστήσετε, αλλάξτε πρώτα την προεπιλεγμένη γλώσσα του συστήματος συζητήσεων.',
	...
	'THOSE_MISSING_LANG_VARIABLES'		=> 'Οι ακόλουθες μεταβλητές γλώσσας λείπουν από το πακέτο γλώσσας “%s”',
