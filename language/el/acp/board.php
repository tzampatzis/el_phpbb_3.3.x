...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'				=> 'Εάν είναι ενεργοποιημένη αυτή η ρύθμιση, ορισμένα αρχεία θα εξυπηρετούνται από εξωτερικούς διακομιστές τρίτων αντί του διακομιστή σας. Αυτό μειώνει το εύρος ζώνης του δικτύου που απαιτείται από τον διακομιστή σας, αλλά μπορεί να παρουσιάσει θέμα Προστασίας Προσωπικών Δεδομένων για κάποιους διαχειριστές του συστήματος συζητήσεων. Σε μια προεπιλεγμένη εγκατάσταση phpBB, αυτό περιλαμβάνει τη φόρτωση “jQuery” και τη γραμματοσειρά “Open Sans” από το περιεχόμενο του δικτύου διανομής της Google.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Μην ορίσετε κάποιο πρωτόκολλο (<samp>ssl://</samp> ή <samp>tsl://</samp>) εκτός και αν σας έχει δώσει διαφορετικές οδηγίες ο πάροχος των mail σας.',
