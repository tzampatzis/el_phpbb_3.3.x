...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Ενεργοποιεί την πιστοποίηση HTTP, επιτρέποντας στους χρήστες να έχουν πρόσβαση σε περιεχόμενο που είναι κρυμμένο από τους επισκέπτες προσθέτοντας την παράμετρο <samp>auth=http</samp> στο URL της τροφοδοσίας. Παρακαλώ να λάβετε υπόψη ότι ορισμένες ρυθμίσεις PHP μπορεί να απαιτήσουν επιπλέον αλλαγές στο αρχείο .htaccess; αναφερθείτε στο αρχείο για οδηγίες. Η πιστοποίηση HTTP υποστηρίζεται μόνο μέσω κρυπτογραφημένων συνδέσεων (https).',
