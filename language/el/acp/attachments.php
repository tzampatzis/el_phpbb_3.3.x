...
$lang = array_merge($lang, array(
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Μέγιστες διαστάσεις συνημμένων εικόνας. Το phpBB ίσως να προσπαθήσει να αλλάζει αυτόματα το μέγεθος των εικόνων πριν τη φόρτωση σε αυτές τις μέγιστες διαστάσεις. Ορίστε και τις δύο τιμές σε 0px με 0px για να απενεργοποιήσετε τον έλεγχο διαστάσεων και την αυτόματη αλλαγή μεγέθους.',
