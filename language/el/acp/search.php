...
$lang = array_merge($lang, array(
	...
	'SEARCH_INDEX_DELETE_REDIRECT'			=> array(
		2	=> 'Όλες οι δημοσιεύσεις μέχρι το id %2$d έχουν αφαιρεθεί από το ευρετήριο αναζήτησης, εκ των οποίων %1$d δημοσιεύσεις σε αυτό το βήμα.<br />',
	),
	'SEARCH_INDEX_DELETE_REDIRECT_RATE'		=> array(
		2	=> 'Ο τρέχων ρυθμός διαγραφής είναι περίπου %1$.1f δημοσιεύσεις ανα δευτερόλεπτο.<br />Διαγραφή σε εξέλιξη…',
	),
