...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER'				=> 'Ο BBCode που προσπαθείτε να προσθέσετε φαίνεται ότι χρησιμοποιεί ένα σύμβολο {TEXT} μέσα σε όρισμα HTML. Αυτό είναι ένα πιθανό θέμα ασφάλειας XSS. Προσπαθήστε να χρησιμοποιήσετε τους πιο περιοριστικούς τύπους {SIMPLETEXT} ή {INTTEXT} αντί αυτού. Προχωρήστε μόνον, εάν έχετε κατανοήσει τους κινδύνους που εμπεριέχονται και θεωρείτε τη χρήση του {TEXT} απολύτως αναπόφευκτη.',
