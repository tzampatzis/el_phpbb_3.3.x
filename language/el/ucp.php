...
$lang = array_merge($lang, array(
	...
	<br><br>
	Η ιστοσελίδα μας είναι βασισμένη στο λογισμικό phpBB (εφεξής “αυτοί”, “αυτών”, “αυτούς”, “λογισμικό phpBB”, “www.phpbb.com”, “phpBB Limited”, “phpBB Teams”), μια λύση συστήματος συζητήσεων που διατίθεται βάσει της “<a href="http://opensource.org/licenses/gpl-2.0.php">GNU General Public License v2</a>” (εφεξής “GPL”) η οποία μπορεί να μεταφορτωθεί από τη σελίδα <a href="https://www.phpbb.com/">www.phpbb.com</a>. Το λογισμικό phpBB μπορεί μόνο να κατυαστήσει λειτουργικές συζητήσεις που βασίζονται στο internet. Η εταιρεία phpBB Limited δεν μπορεί να ασκήσει την επιρροή στο περιεχόμενο και τους στόχους, που επιτρέπονται ή όχι στην παρούσα σελίδα. Για περισσότερες πληροφορίες σχετικά με το phpBB, παρακαλούμε δείτε στο <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
