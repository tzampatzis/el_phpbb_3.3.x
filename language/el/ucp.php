...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Με την πρόσβαση στο “%1$s” (εφεξής “εμείς”, “εμάς”, “δικό μας”, “%1$s”, “%2$s”), δέχεστε ότι δεσμεύεστε νομικά από τους όρους που ακολουθούν. Αν δεν δέχεστε ότι δεσμεύεστε νομικά από όλους τους ακόλουθους όρους, παρακαλούμε μη δημιουργήσετε κάποιον λογαριασμό και μη χρησιμοποιήσετε το “%1$s”. Είναι πιθανόν να μεταβάλλουμε τους όρους οποιαδήποτε χρονική στιγμή και θα επιδιώξουμε να σας ενημερώσουμε για αυτό με τον προσφορότερο δυνατό τρόπο. Ωστόσο, είναι ευθύνη σας να διαβάζετε τακτικά την παρούσα σελίδα, καθώς η συνεχιζόμενη χρήση του “%1$s” μετά τις εκάστοτε αλλαγές δείχνει πως δέχεστε ότι δεσμεύεστε νομικά από αυτούς τους όρους με την ανανεωμένη και/ή τροποποιημένη μορφή των όρων.
	<br><br>
	Η ιστοσελίδα μας είναι βασισμένη στο λογισμικό phpBB (εφεξής “αυτοί”, “αυτών”, “αυτούς”, “λογισμικό phpBB”, “www.phpbb.com”, “phpBB Limited”, “phpBB Teams”), μια λύση συστήματος συζητήσεων που διατίθεται βάσει της “<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>” (εφεξής “GPL”) η οποία μπορεί να μεταφορτωθεί από τη σελίδα <a href="https://www.phpbb.com/">www.phpbb.com</a>. Το λογισμικό phpBB μπορεί μόνο να κατυαστήσει λειτουργικές συζητήσεις που βασίζονται στο internet. Η εταιρεία phpBB Limited δεν μπορεί να ασκήσει την επιρροή στο περιεχόμενο και τους στόχους, που επιτρέπονται ή όχι στην παρούσα σελίδα. Για περισσότερες πληροφορίες σχετικά με το phpBB, παρακαλούμε δείτε στο <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	Δέχεστε να μη δημοσιεύετε οποιασδήποτε μορφής περιεχόμενο που είναι προσβλητικό, άσεμνο, χυδαίο, συκοφαντικό, περιέχον μίσος ή απειλή, σεξουαλικά προσανατολισμένο ή οτιδήποτε άλλο που πιθανόν να παραβιάζει νόμους είτε της χώρας σας, είτε της χώρας στην οποία φιλοξενείται το “%1$s”, είτε το Διεθνές Δίκαιο. Η δημοσίευση τέτοιου περιεχομένου είναι δυνατόν να οδηγήσει στην άμεση και μόνιμη διαγραφή σας, με ταυτόχρονη ενημέρωση της Υπηρεσίας Παροχής Υπηρεσιών Διαδικτύου που χρησιμοποιείτε εφόσον κριθεί απαραίτητο. Η διεύθυνση IP κάθε δημοσίευσης καταγράφεται για τη δυνατότητα επιβολής των παρόντων όρων.
	<br><br>
	Δέχεστε ότι το “%1$s” έχει το δικαίωμα να απομακρύνει, να επεξεργαστεί, να μετακινήσει ή να κλείσει ένα θέμα συζήτησης οποιαδήποτε χρονική στιγμή επιλέξει. Σαν μέλος δέχεστε ότι οποιεσδήποτε πληροφορίες έχετε εισάγει αποθηκεύονται σε μια βάση δεδομένων. Αν και αυτές οι πληροφορίες δεν θα αποκαλυφθούν σε οποιονδήποτε τρίτο χωρίς τη συναίνεσή σας, ούτε το “%1$s” ούτε το phpBB θα θεωρηθούν υπεύθυνοι για οποιαδήποτε απόπειρα ηλεκτρονικής εισβολής ή παραβίασης η οποία είναι δυνατόν να οδηγήσει σε απώλεια αυτών των δεδομένων.
	',
	...
	<br><br>
	Είναι πιθανόν επίσης να δημιουργήσουμε cookies εκτός του λογισμικού phpBB κατά την πλοήγησή σας στο “%1$s”, αν και αυτά είναι έξω από το πεδίο αυτού του εγγράφου, το οποίο καλύπτει μόνο τις σελίδες που δημιουργούνται από το λογισμικό phpBB.
	<br><br>
	Ο δεύτερος τρόπος με τον οποίο συλλέγουμε τις πληροφορίες σας είναι με βάση το υλικό που μας υποβάλετε. Αυτό μπορεί να περιλαμβάνει και να μην περιορίζεται σε: δημοσιεύσεις σαν ανώνυμο μέλος (εφεξής “ανώνυμες δημοσιεύσεις”), εγγραφή στο “%1$s” (εφεξής “ο λογαριασμός σας”) και δημοσιεύσεις που υποβάλετε μετά την εγγραφή και ενώ είστε συνδεδεμένος (εφεξής “οι δημοσιεύσεις σας”).
	<br><br>
