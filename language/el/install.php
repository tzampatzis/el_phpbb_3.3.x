...
$lang = array_merge($lang, array(
	...
	'PHP_VERSION_REQD_EXPLAIN'			=> 'Το phpBB απαιτεί έκδοση PHP 7.1.0 ή νεώτερη.',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Ο προτεινόμενος τρόπος αναβάθμισης της εγκατάστασής σας, είναι η χρήση του πλήρους πακέτου αναβάθμισης. Αν τα βασικά αρχεία του phpBB έχουν τροποποιηθεί στην εγκατάστασή σας, ίσως θέλετε να αναβαθμίσετε χρησιμοποιώντας το αυτόματο πακέτο αναβάθμισης για να μην χάσετε όποιες μετατροπές έχετε κάνει. Μπορείτε επίσης να αναβαθμίσετε την εγκατάστασή σας, χρησιμοποιώντας τις υπόλοιπες μεθόδους που αναφέρονται στο έγγραφο INSTALL.html. Τα βήματα για να αναβαθμίσετε το phpBB3 χρησιμοποιώντας το πλήρες πακέτο είναι τα εξής:</p>
		...
		<h1>Πώς να αναβαθμίσετε την εγκατάστασή σας με το πακέτο αυτόματης αναβάθμισης</h1>

		<p>Το αυτόματο πακέτο αναβάθμισης προτείνεται μόνο όταν έχετε κάνει μετατροπές στα βασικά αρχεία του phpBB. Μπορείτε επίσης να αναβαθμίσετε την εγκατάστασή σας, χρησιμοποιώντας τις υπόλοιπες μεθόδους που αναφέρονται στο έγγραφο INSTALL.html. Τα βήματα για να αναβαθμίσετε το phpBB3 χρησιμοποιώντας το αυτόματο πακέτο αναβάθμισης είναι τα εξής:</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li>Πηγαίνετε στη <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">σελίδα μεταφορτώσεων του phpBB.com</a> και κατεβάστε το πιο πρόσφατο "Automatic Update Package" αρχείο.</li>
			<li>Αποσυμπιέστε το συμπιεσμένο αρχείο.</li>
