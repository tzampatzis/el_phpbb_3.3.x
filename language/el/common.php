...
$lang = array_merge($lang, array(
	...
	'HOURS'						=> 'Ώρες',
	'HOME'						=> 'Αρχική σελίδα',
	'HTTP_HANDLER_NOT_FOUND'		=> 'Η εργασία δεν κατάφερε να ολοκληρωθεί διότι η προσθήκη cURL της PHP και η ρύθμιση allow_url_fopen στο αρχείο ρυθμίσεων PHP (ini) έχουν απενεργοποιηθεί και δεν μπορεί να βρεθεί κάποιος άλλος χειριστής HTTP.',
