...
$lang = array_merge($lang, array(
	...
	'CLI_DESCRIPTION_USER_DELETE'				=> 'Διαγραφή λογαρισμού μέλους.',
	...
	'CLI_USER_ADD_SUCCESS'		=> 'Επιτυχείς προσθήκη του μέλους %s.',
	'CLI_USER_DELETE_CONFIRM'	=> 'Είστε σίγουρος (-η) ότι θέλετε να διαγράψετε το μέλος ‘%s’; [y/N]',
	'CLI_USER_RECLEAN_START'	=> 'Επανακαθαρισμός ονομάτων χρηστών',
