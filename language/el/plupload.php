...
$lang = array_merge($lang, array(
	...
	'PLUPLOAD_ALREADY_QUEUED'		=> 'Το %s υπάρχει ήδη στην ουρά.',
	'PLUPLOAD_CLOSE'				=> 'Κλείσιμο',
	'PLUPLOAD_DRAG'					=> 'Σύρετε αρχεία εδώ.',
	'PLUPLOAD_DUPLICATE_ERROR'		=> 'Σφάλμα διπλασιασμού αρχείου.',
	'PLUPLOAD_DRAG_TEXTAREA'		=> 'Μπορείτε επίσης να επισυνάψετε αρχεία με μεταφορά και απόθεσή τους στο πλαίσιο μηνύματος.',
	...
	'PLUPLOAD_IMAGE_FORMAT'			=> 'Ο τύπος της εικόνας είτε είναι λάθος ή δεν υποστηρίζεται.',
