...
$lang = array_merge($lang, array(
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'Κάτι πήγε στραβά κατά τη διάρκεια του αιτήματος και μια εξαίρεση δεν έγινε. Οι αλλαγές που πραγματοποιήθηκαν πριν από το σφάλμα αντιστράφηκαν κατά το καλύτερο των δυνατοτήτων μας, αλλά θα πρέπει να ελέγξετε το σύστημα συζητήσεων για λάθη:<br><br>%s',
