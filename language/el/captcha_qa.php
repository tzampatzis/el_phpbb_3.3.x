...
$lang = array_merge($lang, array(
	...
	'ANSWERS_EXPLAIN'			=> 'Παρακαλώ εισάγετε έγκυρες απαντήσεις στην ερώτηση, μια ανά γραμμή',
	'CONFIRM_QUESTION'			=> 'Ερώτηση',

	'ANSWER'					=> 'Απάντηση',
	'EDIT_QUESTION'				=> 'Επεξεργασία ερώτησης',
	'QUESTIONS'					=> 'Ερωτήσεις',
	'QUESTIONS_EXPLAIN'			=> 'Για κάθε υποβολή φόρμας όπου έχετε ενεργοποιήσει τη μονάδα Q&amp;A, τα μέλη θα ερωτηθούν με μια από τις ερωτήσεις που καθορίζονται εδώ. Για να χρησιμοποιήσετε αυτή τη μονάδα τουλάχιστον μια ερώτηση πρέπει να οριστεί στην προεπιλεγμένη γλώσσα. Αυτές οι ερωτήσεις θα πρέπει να είναι εύκολες για το κοινό στο οποίο απευθύνονται για να απαντήσει, αλλά πέραν της ικανότητας ενός bot να μπορεί να λειτουργεί μια αναζήτηση στο Google™. Μόνο μια ιδανική ερώτηση είναι απαραίτητη. Αν αρχίσετε να έχετε εγγραφές spam, η ερώτηση πρέπει να αλλάξει. Ενεργοποιήστε την αυστηρή λειτουργία αν η ερώτησή σας βασίζεται σε κεφαλαία και πεζά, τονισμό ή κενούς χαρακτήρες.',
